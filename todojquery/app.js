...
function getItems() {
    ...
    $.ajax({
        dataType:'json',
        url:location.protocol + '//' + location.host + '/rest/db/todo',
        data:'app_name=todojquery',
        cache:false,
...
function deleteItem(id) {
    ...
    $.ajax({
        dataType:'json',
        type : "DELETE",
        url:location.protocol + '//' + location.host + '/rest/db/todo/' + id + '?app_name=todojquery',
        cache:false,
        processData: false,
        success:function (response) {
            getItems();
